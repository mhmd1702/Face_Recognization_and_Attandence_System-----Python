...
class FaceFeaturesExtractor:
    def __init__(self):
        ...
        self.predictor = dlib.shape_predictor('f:/face/data_dlib/shape_predictor_68_face_landmarks.dat')
        self.face_reco_model = dlib.face_recognition_model_v1("f:/face/data_dlib/dlib_face_recognition_resnet_model_v1.dat")
